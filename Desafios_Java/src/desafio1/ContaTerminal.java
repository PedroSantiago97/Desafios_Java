...
public class ContaTerminal {
	public static void main(String[] args) {
        ...
        System.out.println("Olá " + nomeCliente + " "+ sobrenomeCliente +", obrigado por criar uma conta no nosso banco, sua agência é "+ agencia+"-"+digitoAgencia + " conta " + conta + " e seu saldo que é de R$" + String.format("%.2f", saldo) + " ja está disponível !");
